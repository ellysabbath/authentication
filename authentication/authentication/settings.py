...
SECRET_KEY = 'django-insecure-bove$17o__acq5b$nu!#o_(1$cony)m59t0s&uf5yk-7q#7n2w'
...
LOGOUT_REDIRECT_URL = 'logged_out'  # This assumes you will name the URL 'logged_out'
ALLOWED_HOSTS=['*']
# settings.py

SITE_URL = 'http://192.168.137.1:8000/auth'

# settings.py (example configuration for sending email)
# settings.py
